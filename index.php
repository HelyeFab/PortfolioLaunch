...
<head>
    ...
    <title>CodeLeviosaPortfolio </title>
</head>
...
<body>
    ...
    <section class="home card" id="home">
        <div class="grid">
            ...
            <nav class="navBar">
                <button class="homeMenuBtn barIcon">
                ...
                <div class="themeMenu">
                    <span>Site accents</span>
                    <ul class="themeMenu-accents-colors">


                        <li id="violet">#345995ff</li>
                        <li id="orange">#fb4d3dff</li>
                        <li id="darkPink">#ca1551ff</li>
                        <li id="purple">#883aac</li>
                        <li id="yellow">#edd83d</li>
                    </ul>
                    <div class="switch__container">
                        <span>Light Theme</span>
                        <div class="switch__container-toggle">
                            <input type="checkbox" id="theme" checked=checked>
                ...
                <button class="themeMenuBtn barIcon">
                    <i class="fas fa-cog fa fa icon"></i>
                </button>

            </nav>


            <div class="content__visual contentHome">
                <svg class="svgHome" id="f7bb3db6-0aca-42e3-bcc4-5e9b3a55e19d" data-name="Layer 1"
                    xmlns="http://www.w3.org/2000/svg" width="879.5" height="581.35056" viewBox="0 0 879.5 581.35056">
                    ...
                    <path class="colorCustom"
                        ...
                        transform="translate(-160.25 -159.32472)" fill="#00bfa6" />
                    <path
                    ...
                    <polygon points="679.124 524.941 679.124 546.514 661.633 552.928 661.633 527.856 679.124 524.941"
                        fill="#ffb8b8" />
                    <polygon points="643.558 522.609 655.219 548.846 638.894 555.843 635.395 530.189 643.558 522.609"
                        fill="#ffb8b8" />
                    <path
            ...
            <div class="content__text">
                <div class="content__text-title">
                    <h1>I'm <br> <mark class="highlight"><span>Emmanuel</span> </mark></h1>
                </div>
                <div class="content__text-subtitle">
                    <p>A Front End <mark class="highlight"> <span class="typed-text"></span><span
                                class="cursor typing">&nbsp</span>
                        </mark></p>
                </div>
                <div class="hero-btn btn themeColor">
                    <a href="#portfolio">My Portoflio</a>
                </div>
    ...
    <section class="about card" id="about">
        <div class="gridSecondaryReverse">
            <div class="content__text">
                <div class="content__text-title">
                    <h3> From <br> Project Manager to <mark class="highlight"><span>Software Engineer</span>
                        </mark></h3>
                </div>
                <div class="content__text-subtitle">
                    <p>I've been a project manager for most of my life and I have enjoyed it greatly... <br> However, I
                        have always wanted to be a developer...So when Life presented me with the right opportunity <br>
                        I knew exactly what I had to do.
                    </p>
                </div>

                <div class="about__me-skills">
                    <div class="about__me-skills-title">
                        <h3> My <mark class="highlight"><span>Tool Box</span>
                            </mark> </h3>
                    </div>
                    <div class="about__me-skills loader">
                        <div class="loader__dial l1">
                            <i class="fab fa-html5"></i>
                        </div>
                        <div class="loader__dial l2">
                            <i class="fab fa-css3-alt"></i>
                        </div>
                        <div class="loader__dial l3">
                            <i class="fab fa-sass"></i>
                        </div>
                        <div class="loader__dial l4">
                            <i class="fab fa-bootstrap"></i>
                        </div>
                        <div class="loader__dial l5">
                            <i class="fab fa-js-square"></i>
                        </div>
                        <div class="loader__dial l6">
                            <i class="fab fa-npm"></i>
                        </div>
                        <div class="loader__dial l7">
                            <i class="fab fa-node-js"></i>
                        </div>
                        <div class="loader__dial l8">
            ...
            <div class="content__visual">
                <svg id="b3347a10-18dd-4c71-91c3-38a98340ba03" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                    width="963.50956" height="774.36439" viewBox="0 0 963.50956 774.36439">
                    ...
                    <path
                        ...
                        transform="translate(-118.24522 -62.8178)" fill="#ffb8b8" />
                    <path d="M724.31335,386.28047l-9.26085,15.43474s15.43475,0,18.52169,23.15211l12.3478-15.43474Z"
                        transform="translate(-118.24522 -62.8178)" fill="#cfcce0" />
                    <polygon
                    ...
                    <path
                        ...
                        transform="translate(-118.24522 -62.8178)" fill="#2f2e41" />
                    <path
                    ...
                    <path
                        ...
                        transform="translate(-118.24522 -62.8178)" fill="#575a89" />
                    <path
                    ...
                    <path
                        ...
                        transform="translate(-118.24522 -62.8178)" fill="#ffb8b8" />
                    <polygon points="803.633 340.441 789.742 357.419 771.22 325.006 778.937 311.115 803.633 340.441"
                        fill="#cfcce0" />
                    <path
                    ...
                    <path
                        ...
                        transform="translate(-118.24522 -62.8178)" fill="#2f2e41" />
                    <ellipse cx="730.3178" cy="56.44164" rx="4.32173" ry="5.40216" fill="#ffb8b8" />
                    <polygon points="178.601 318.118 45.361 318.118 45.361 280.782 114.91 280.782 178.601 318.118"
                        fill="#00bfa6" />
                    <path
                        ...
                        transform="translate(-118.24522 -62.8178)" fill="#3f3d56" />
                    <polygon points="178.601 141.685 45.361 141.685 45.361 104.348 114.91 104.348 178.601 141.685"
                        fill="#00bfa6" />
                    <path
                        ...
                        transform="translate(-118.24522 -62.8178)" fill="#3f3d56" />
                    <polygon points="178.601 490.891 45.361 490.891 45.361 453.555 114.91 453.555 178.601 490.891"
                        fill="#00bfa6" />
                    <path
                    ...
                    <path class="colorCustom"
                        ...
                        transform="translate(-118.24522 -62.8178)" fill="#00bfa6" />
                    <polygon
    ...
    <section class="portfolio card" id="portfolio">
        <div class="gridSecondary">
            <div class="content__visual">
                <svg id="196ecc45-c3c6-4b7d-8685-374129418fe3" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink" width="885" height="856.96" viewBox="0 0 885 856.96">
                    <defs>
                        <linearGradient id="431b905b-f630-4d26-9705-072736e3fa0a" x1="613.19" y1="813.7" x2="613.19"
                            y2="105.57" gradientTransform="translate(-0.86 -10.23)" gradientUnits="userSpaceOnUse">
                            <stop offset="0" stop-color="gray" stop-opacity="0.25" />
                            <stop offset="0.54" stop-color="gray" stop-opacity="0.12" />
                            <stop offset="1" stop-color="gray" stop-opacity="0.1" />
                        </linearGradient>
                        <linearGradient id="82c9264e-9b45-4df5-9d25-f7dacbcab158" x1="613.84" y1="152.52" x2="613.84"
                            y2="92.5" gradientTransform="translate(-140.84 19.9)"
                            xlink:href="#431b905b-f630-4d26-9705-072736e3fa0a" />
                        <linearGradient id="e7f96ace-9b05-41bf-887d-5e87841d3793" x1="613.84" y1="104.78" x2="613.84"
                            y2="33.84" gradientTransform="translate(-136.32 285.71) rotate(-24.52)"
                            xlink:href="#431b905b-f630-4d26-9705-072736e3fa0a" />
                        <linearGradient id="0e5c1f30-7912-44d8-85da-be3b7e04fbbd" x1="440.4" y1="329.87" x2="440.4"
                            y2="222.94" gradientTransform="translate(-61.32 78.01)"
                            xlink:href="#431b905b-f630-4d26-9705-072736e3fa0a" />
                        <linearGradient id="f5898732-89b1-47b9-bad4-993f506fb52e" x1="440.76" y1="541.79" x2="440.76"
                            y2="434.85" gradientTransform="translate(26.6 58.74)"
                            xlink:href="#431b905b-f630-4d26-9705-072736e3fa0a" />
                        <linearGradient id="f9eac279-a8ac-46d5-97b7-7547b98d8743" x1="440.4" y1="302" x2="440.4"
                            y2="249.51" gradientTransform="translate(-293.43 264.79) rotate(-24.52)"
                            xlink:href="#431b905b-f630-4d26-9705-072736e3fa0a" />
                        <linearGradient id="56bc9504-3ea8-4a78-ad29-d599ef16b1a5" x1="599.62" y1="607.1" x2="599.62"
                            y2="100.78" gradientTransform="matrix(1, 0, 0, 1, 0, 0)"
                            xlink:href="#431b905b-f630-4d26-9705-072736e3fa0a" />
                    </defs>
                    <title>agreement</title>
                    <g opacity="0.5">
                        <rect x="356.07" y="95.34" width="512.51" height="708.13"
                            transform="translate(-288.4 273.74) rotate(-24.52)"
                            fill="url(#431b905b-f630-4d26-9705-072736e3fa0a)" />
                    </g>
                    <rect x="361.51" y="100.79" width="499.47" height="692.48"
                        transform="translate(-287.52 273.08) rotate(-24.52)" fill="#fff" />
                    <rect x="349.12" y="112.4" width="247.78" height="60.02"
                    ...
                    <path
                        ...
                        transform="translate(-157.12 -20.92)" fill="url(#e7f96ace-9b05-41bf-887d-5e87841d3793)" />
                    <rect x="351.19" y="112.55" width="242.56" height="57.38"
                        transform="translate(-173.12 187.91) rotate(-24.52)" fill="#6c63ff" />
                    <path class="colorCustom"
                        ...
                        transform="translate(-157.12 -20.92)" fill="#6c63ff" />
                    <rect x="325.61" y="300.95" width="106.94" height="106.94"
                        transform="translate(-270.02 168.37) rotate(-24.52)"
                        fill="url(#0e5c1f30-7912-44d8-85da-be3b7e04fbbd)" />
                    <rect x="413.89" y="493.6" width="106.94" height="106.94"
                        transform="translate(-342.01 222.39) rotate(-24.52)"
                        fill="url(#f5898732-89b1-47b9-bad4-993f506fb52e)" />
                    <rect x="329.52" y="304.86" width="99.11" height="99.11"
                        transform="translate(-270.02 168.37) rotate(-24.52)" fill="#69f0ae" />
                    <rect x="416.66" y="495.88" width="99.11" height="99.11"
                        transform="translate(-341.44 221.76) rotate(-24.52)" fill="#6c63ff" />
                    <rect x="471.46" y="260.92" width="135.85" height="9.48"
                        transform="translate(-218.73 226.9) rotate(-24.52)" fill="#e0e0e0" />
                    <rect x="473.37" y="255.5" width="224.31" height="9.48"
                        transform="translate(-212.31 245.56) rotate(-24.52)" fill="#e0e0e0" />
                    <rect x="479.98" y="271.71" width="208.51" height="9.48"
                        transform="translate(-219.16 246.49) rotate(-24.52)" fill="#e0e0e0" />
                    <rect x="558.6" y="451.95" width="135.85" height="9.48"
                        transform="translate(-290.15 280.29) rotate(-24.52)" fill="#e0e0e0" />
                    <rect x="560.51" y="446.52" width="224.31" height="9.48"
                        transform="translate(-283.73 298.95) rotate(-24.52)" fill="#e0e0e0" />
                    <rect x="567.12" y="462.74" width="208.51" height="9.48"
                        transform="translate(-290.58 299.88) rotate(-24.52)" fill="#e0e0e0" />
                    <polygon
                    ...
                    <polygon
                        ...
                        fill="#fff" />
                    <rect x="553.74" y="615.49" width="316.9" height="105.63"
                        transform="translate(-370.25 334.93) rotate(-24.52)" fill="#e0e0e0" />
                    <path class="colorCustom"
                    ...
                    <path
                        ...
                        transform="translate(-157.12 -20.92)" fill="url(#56bc9504-3ea8-4a78-ad29-d599ef16b1a5)" />
                    <polygon points="681.9 418.48 592.88 497.6 523.65 369.02 681.9 329.46 681.9 418.48"
                        fill="#be7c5e" />
                    <path
                        ...
                        transform="translate(-157.12 -20.92)" fill="#fda57d" />
                    <path
                        ...
                        transform="translate(-157.12 -20.92)" fill="#be7c5e" />
                    <rect x="456.83" y="463.57" width="48.96" height="76.93" rx="22.21" ry="22.21"
                        transform="translate(338.85 -214.21) rotate(45)" fill="#be7c5e" />
                    <rect x="424.96" y="426.21" width="48.96" height="76.93" rx="22.21" ry="22.21"
                        transform="translate(303.09 -202.62) rotate(45)" fill="#be7c5e" />
                    <rect x="498.86" y="487.27" width="48.96" height="83.92" rx="22.21" ry="22.21"
                        transform="translate(370.39 -235.97) rotate(45)" fill="#be7c5e" />
                    <rect x="540.04" y="526.26" width="34.19" height="55.95" rx="15.51" ry="15.51"
                        transform="translate(397.97 -252.54) rotate(45)" fill="#be7c5e" />
                    <polygon points="780.8 438.26 691.79 477.82 602.77 260.23 681.9 230.56 780.8 438.26" fill="#fff" />
                    <polygon points="108.25 388.81 197.26 428.37 286.28 210.78 207.15 181.1 108.25 388.81"
                        fill="#fff" />
                    <polygon points="9.34 92.09 207.15 181.1 78.58 477.82 9.34 448.15 9.34 92.09" fill="#333" />
                    <polygon points="879.71 141.54 681.9 230.56 810.48 527.27 879.71 497.6 879.71 141.54"
                        fill="#4d8af0" />
                </svg>
            </div>
            ...
            <div class="content__text">
                <div class="content__text-title">
                    <h2>My <br> <mark class="highlight"><span>Portfolio</span> </mark></h2>
                </div>
            </div>
            <!-- grid portfolio item -->
            <!-- Natours -->
            <div class="portfolio__item natours">
                <div class="portfolio__item-content">
                    <img src="/css/assets/img/File 5.jpg" alt="Natours Website">
                </div>
                <div class="portfolio__item-bar">
                    <a href="https://github.com/HelyeFab/LeviosaNature"> <span>Code &#8594</span></a>
                    <a href="https://cocky-hopper-2b0bad.netlify.app/"><span>Live &#8594</span></a>
                </div>
            </div>
            <!-- Natours -->
            <!-- Omnifood -->
            <div class="portfolio__item omnifood">
                <div class="portfolio__item-content">
                    <img src="/css/assets/img/File 4.jpg" alt="Omnifood Website">
                </div>
                <div class="portfolio__item-bar">
                    <a href="https://github.com/HelyeFab/newOmniFood"> <span>Code &#8594</span></a>
                    <a href="https://festive-allen-3bd17a.netlify.app/"><span>Live &#8594</span></a>
                </div>
            </div>
            <!-- Omnifood -->
            <!-- Trello -->
            <div class="portfolio__item trello">
                <div class="portfolio__item-content">
                    <img src="/css/assets/img/File 3.jpg" alt="Trello Website">
                </div>
                <div class="portfolio__item-bar">
                    <a href="https://github.com/HelyeFab/Trello"> <span>Code &#8594</span></a>
                    <a href="https://competent-kepler-114202.netlify.app/"><span>Live &#8594</span></a>
                </div>
            </div>
            <!-- Trello -->

            <!-- Tasklist -->
            <div class="portfolio__item tasklist">
                <div class="portfolio__item-content">
                    <img src="/css/assets/img/File 2.jpg" alt="Tasklist javascript project">
                </div>
                <div class="portfolio__item-bar">
                    <a href="https://github.com/HelyeFab/taskList"> <span>Code &#8594</span></a>
                    <a href="https://kind-elion-f05501.netlify.app/"><span>Live &#8594</span></a>
                </div>
            </div>
            <!-- Tasklist -->
            <!-- Calculator -->
            <div class="portfolio__item calculator">
                <div class="portfolio__item-content">
                    <img src="/css/assets/img/File 1.jpg" alt="Calculator javascript project">
                </div>
                <div class="portfolio__item-bar">
                    <a href="https://github.com/HelyeFab/Neumorphic-Calculator"> <span>Code &#8594</span></a>
                    <a href="https://serene-keller-547e96.netlify.app/"><span>Live &#8594</span></a>
                </div>
            </div>
            <!-- Calculator -->
            <!-- WeatherWidget -->
            <div class="portfolio__item weatherWidget">
                <div class="portfolio__item-content weather">
                    <img class="cover" src="/css/assets/img/File 6.jpg" alt="Calculator javascript project">
                </div>
                <div class="portfolio__item-bar weather-bar">
                    <a href="https://github.com/HelyeFab/WeatherWidget"> <span>Code &#8594</span></a>
                    <a href="https://codeleviosaweatherwidget.netlify.app/"><span>Live &#8594</span></a>
                </div>
            </div>
            <!-- WeatherWidget -->
            <!-- grid portfolio item -->
          ...
          <input type="submit" name="submit" class="hero-btn btn themeColor send_btn" value="Send">
            ...
            <div class="content__visual">
                <svg id="b9c085e1-b209-40d5-b9c5-2decca8817ec" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink" width="1177" height="494.25" viewBox="0 0 1177 494.25">
                    <defs>
                        <linearGradient id="e1e32c93-0bc3-4bc5-85c6-efac924cbce5" x1="313.79" y1="660.67" x2="313.79"
                            y2="660.43" gradientTransform="matrix(-1, 0, 0, 1, 651, 0)" gradientUnits="userSpaceOnUse">
                            <stop offset="0" stop-color="gray" stop-opacity="0.25" />
                            <stop offset="0.54" stop-color="gray" stop-opacity="0.12" />
                            <stop offset="1" stop-color="gray" stop-opacity="0.1" />
                        </linearGradient>
                    ...
                    <path
                        ...
                        transform="translate(-11.5 -202.87)" fill="#3f3d56" />
                    ...
                    <path
                        ...
                        transform="translate(-11.5 -202.87)" fill="#3f3d56" />
                    <circle cx="193" cy="23.5" r="6" fill="#00bfa6" />
                    <circle cx="208" cy="23.5" r="6" fill="#00bfa6" />
                    <circle cx="223" cy="23.5" r="6" fill="#00bfa6" />
                    <path d="M347.5,429.38" transform="translate(-11.5 -202.87)" fill="none" stroke="#f2f2f2"
                        stroke-miterlimit="10" stroke-width="2" />
                    <path d="M333.5,428.38" transform="translate(-11.5 -202.87)" fill="none" stroke="#f2f2f2"
                        stroke-miterlimit="10" stroke-width="2" />
                    <rect x="610.5" y="93.12" width="347" height="11" rx="1.24" fill="#00bfa6" opacity="0.3" />
                    <rect x="879.5" y="114.12" width="73" height="25" rx="1.24" fill="#00bfa6" />
                    <rect x="610.5" y="226.88" width="347" height="11" rx="1.24" fill="#00bfa6" opacity="0.3" />
                    <rect x="879.5" y="247.88" width="73" height="25" rx="1.24" fill="#00bfa6" />
                    <rect x="610.5" y="362.88" width="347" height="11" rx="1.24" fill="#00bfa6" opacity="0.3" />
                    <rect x="879.5" y="383.88" width="73" height="25" rx="1.24" fill="#00bfa6" />
                    ...
                    <path
                        ...
                        transform="translate(-11.5 -202.87)" fill="#192534" />
                    <path
                    ...
                    <path
                        ...
                        transform="translate(-11.5 -202.87)" fill="#a0616a" />
                    <path
                        d="M538,465a6.5,6.5,0,0,1-.34,3c-.59,1.37-2,2.6-1.61,4a3.07,3.07,0,0,0,2.16,1.74c4.31,1.46,9,.59,13.56.79a43.72,43.72,0,0,0,4.57.16,7.28,7.28,0,0,0,4.24-1.48,36.3,36.3,0,0,1-6.67-4.19,7.5,7.5,0,0,1-1.35-1.29,7.91,7.91,0,0,1-1.17-4.58c0-1.59,0-3.18,0-4.76-3.26,0-6.51-.05-9.77-.05-1,0-4.23-.25-4.6.88-.18.56.52,2.21.63,2.84A28.28,28.28,0,0,1,538,465Z"
                        transform="translate(-11.5 -202.87)" opacity="0.1" />
                    ...
                    <path class="colorCustom"
                        ...
                        transform="translate(-11.5 -202.87)" fill="#00bfa6" />
                    <path
                        d="M531.4,486.18c-1.07.24-1.69,1.32-2.19,2.3a8.89,8.89,0,0,0-1.19,5.34,7.53,7.53,0,0,0,.23,2.17,2.88,2.88,0,0,0,1.26,1.72"
                        transform="translate(-11.5 -202.87)" fill="none" stroke="#000" stroke-miterlimit="10"
                        opacity="0.1" />
                    <ellipse cx="547.6" cy="443.78" rx="6.34" ry="12.85"
                        transform="translate(-29.44 661.57) rotate(-75.66)" fill="#192534" />
                    <path
                    ...
                    <path
                        ...
                        transform="translate(-11.5 -202.87)" fill="#ffc1c7" />
                    <path
                        d="M539.48,611.13A9.22,9.22,0,0,0,537,612c-1.38,1-1.33,3-.92,4.63.94,3.72,3.24,7.29,6.76,8.81a16.71,16.71,0,0,0,6.82,1c2.51,0,5.35-.34,6.91-2.32a9.17,9.17,0,0,0,1.41-3.46c.77-3,1.55-6.1,1.27-9.2-1.52.13-3.22.22-4.42-.74s-1.47-2.79-2-4.31a1.13,1.13,0,0,0-.39-.62,1.27,1.27,0,0,0-.7-.1,28.29,28.29,0,0,1-4.78-.2c-1-.13-3.42-1.16-4.16-.29-.54.63-.2,2.55-.62,3.44A4.76,4.76,0,0,1,539.48,611.13Z"
                        transform="translate(-11.5 -202.87)" opacity="0.05" />
                    ...
                    <path
                        ...
                        transform="translate(-11.5 -202.87)" fill="#fbbebe" />
                    <path
                        d="M543.05,334.64a6,6,0,0,1-3.31,3.33c-.81.29-1.68.34-2.5.57a2.77,2.77,0,0,0-1.94,1.53,3.28,3.28,0,0,0-.15,1.08c-.13,3.45-.23,7,1.15,10.2,1.19,2.74,3.37,4.9,5.53,6.95,2.52,2.41,5.19,4.85,8.51,5.93,1.94.63,4.23.7,5.84-.55a8.67,8.67,0,0,0,1.63-1.89,22.86,22.86,0,0,0,2.8-4.77c1.37-3.52.91-7.46.43-11.21a.9.9,0,0,0-.24-.6.94.94,0,0,0-.7-.12,4.12,4.12,0,0,1-4.17-2.4,6.26,6.26,0,0,1-.23-2.2l.07-4.28a3.63,3.63,0,0,0-.16-1.36,3.42,3.42,0,0,0-1.79-1.55,44.23,44.23,0,0,0-7.28-2.87c-1.1-.32-1.94-.86-2.43.32S543.62,333.4,543.05,334.64Z"
                        transform="translate(-11.5 -202.87)" opacity="0.1" />
                    ...
                    <path
                        ...
                        transform="translate(-11.5 -202.87)" fill="#f2f2f2" />
                    <path class="colorCustom"
                    ...
                    <path class="colorCustom"
                        ...
                        transform="translate(-11.5 -202.87)" fill="#00bfa6" />
                    <path d="M337.43,660.43h0l-.44.24Z" transform="translate(-11.5 -202.87)"
                    ...
                    <path
                        ...
                        transform="translate(-11.5 -202.87)" fill="#575a89" />
                    <path
                        ...
                        transform="translate(-11.5 -202.87)" fill="#cbceda" />
                    <path
                    ...
                    <path
                        ...
                        transform="translate(-11.5 -202.87)" opacity="0.1" />
                    <path d="M285.58,418.33A16.44,16.44,0,1,0,302,401.9,16.35,16.35,0,0,0,285.58,418.33Z"
                        transform="translate(-11.5 -202.87)" fill="#fbbebe" />
                    <path
                    ...
                    <path
                        ...
                        transform="translate(-11.5 -202.87)" fill="#3f3d56" />
                    <path d="M309.07,460.54l-5,20.73S300.05,481.24,309.07,460.54Z" transform="translate(-11.5 -202.87)"
                        opacity="0.1" />
                    <path d="M291.83,457.08s6.61,10.82,4,22l-1.23.09S296.83,474,291.83,457.08Z"
                        transform="translate(-11.5 -202.87)" opacity="0.1" />
                    <path d="M287.64,518.3s-8.11-2.68-8.7,3.54C278.94,521.84,280.47,517.57,287.64,518.3Z"
                        transform="translate(-11.5 -202.87)" opacity="0.1" />
                    <path d="M311.09,482.53s1.61,11.28-1.29,15.79A35.21,35.21,0,0,0,324,500.25l1-17.72Z"
                        transform="translate(-11.5 -202.87)" opacity="0.1" />
                    <path d="M310,497.05l.78.44,5-11.25-4.67-4.19h-.25v0C310.92,482.59,312.22,492.28,310,497.05Z"
                        transform="translate(-11.5 -202.87)" opacity="0.1" />
                    <path d="M311.09,482.05s1.61,11.28-1.29,15.79A35.43,35.43,0,0,0,324,499.77l5.64-17.72Z"
                        transform="translate(-11.5 -202.87)" fill="#3f3d56" />
                    <path
                    ...
                    <path d="M277.74,587.58s3.71,2.32,3.84,3.65-1.92-1-1.92-1Z" transform="translate(-11.5 -202.87)"
                        opacity="0.1" />
                    <path
                    ...
                    <path
                        ...
                        transform="translate(-11.5 -202.87)" fill="none" stroke="#3f3d56" stroke-miterlimit="10"
                        stroke-width="4" />
                    <path class="colorCustom"
                    ...
                    <path
                        ...
                        transform="translate(-11.5 -202.87)" fill="#656380" />
                    <path
                        ...
                        transform="translate(-11.5 -202.87)" opacity="0.2" />
                </svg>
            </div>
        </div>
        <div class="footer">
            <p>Created with<mark class="highlight"><span> <img src="/css/assets/svg/love.svg" alt="heart"
            class="love"></span> </mark> by CodeLeviosa&copy;</p>
            <p><mark class="highlight"><span>All Rights reserved</span></mark> 2020</p>
        </div>
